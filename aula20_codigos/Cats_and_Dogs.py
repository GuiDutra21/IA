...
learning_rate_reduction = ReduceLROnPlateau(monitor = 'val_accuracy',mode = 'max',patience = 2,verbose = 1,factor = 0.5,min_lr = 0.00001)
...
'''Save the model:'''
model.save("model1.1_catsVSdogs_10epoch.h5")
...
# Criar test_generator AQUI, usando test_df
test_datagen = ImageDataGenerator(rescale=1./255)  # Sem augmentation no teste
test_generator = test_datagen.flow_from_dataframe(
    test_df,
    "./dogs-vs-cats/test1/",
    x_col='filename',
    y_col=None,  # ❗ Test não tem labels
    target_size=Image_Size,
    class_mode=None,  # ❗ Sem classes, só predição
    batch_size=batch_size,
    shuffle=False  # ❗ Manter ordem para associar com test_df
)
