# Retirado de: https://github.com/brandhaug/umbrella-world-hmm/blob/master/umbrella-world.py
import numpy as np
...
#observations_2 = [False, False, False, True, True, True, True]

if __name__ == '__main__':
    print("Forward probabilities (Task A1):")
    forward_1 = forward(observations_1)
    print("\nForward probabilities (Task A2):")
    forward_2 = forward(observations_2)

    print("\nBackward probabilities (Task B1):")
    backward_1 = backward(observations_1, True)
    print("\nBackward probabilities (Task B2):")
